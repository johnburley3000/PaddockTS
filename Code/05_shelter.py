"""
Description:
This script creates plots analysing shelter benefits

Requirements:
- Modules: python3/3.11.7 
- Environment base: /g/data/xe2/datasets/Environments/paddockenv3_11  (for contextily maps)
...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="""Run the shelter analysis
        
Example usage:
python3 Code/05_shelter.py --stub test --outdir /g/data/xe2/cb8590 --tmpdir /scratch/xe2/cb8590 --lat -34.3890 --lon 148.4695 --buffer 0.01 --start_time '2020-01-01' --end_time '2020-03-31'""",
...
if __name__ == "__main__":
    ...
    # Just copying everything from the jupyter notebook to save time
    ...
    ax.set_title(f"Weather", fontsize=title_fontsize)
    ax.legend(fontsize=tick_size, loc='upper left')
    ax.tick_params(axis='both', labelsize=tick_size)
